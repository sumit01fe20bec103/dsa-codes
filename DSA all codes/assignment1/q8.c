/*8) A middle class family would always like to spend the money wisely, because of their
financial status. They can’t afford to purchase the luxurious items unlike the Rich Class
family. Even if they do, they do it very occasionally.  In order to keep track of the
expenditure of the entire year, the middle class family maintains a record of how much they
spent every month of that year.
